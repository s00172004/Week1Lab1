...
namespace SoloDB.Controllers
{
    public class ConsolesController : Controller
    {
        private SoloContext db = new SoloContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Company,Price")] Models.Console console)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Company,Price")] Models.Console console)
        {
            if (ModelState.IsValid)
            {
